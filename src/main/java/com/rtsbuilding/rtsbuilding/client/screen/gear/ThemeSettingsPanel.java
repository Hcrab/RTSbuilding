...
public final class ThemeSettingsPanel extends RtsWindowPanel {
    ...
    private void drawThemeRow(RtsGuiContext g, MinecraftUiCanvas canvas, int visibleRow,
    ...
    private void drawActions(RtsGuiContext g, MinecraftUiCanvas canvas, int x, int y, int w,
    ...
    private void drawButton(RtsGuiContext g, MinecraftUiCanvas canvas, int x, int y, int w, int h,
