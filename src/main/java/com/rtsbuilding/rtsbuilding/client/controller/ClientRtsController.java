...
public static ClientRtsController get() {
    ...
    public void linkStoragesInSelection(BlockPos first, BlockPos second, boolean allowStore) {
        this.commandOwner.linkStoragesInSelection(first, second, allowStore);
    }
...
public static AreaMineBounds computeAreaMineBounds(BlockPos pointA, BlockPos pointB, int heightOffset) {
    ...
    public boolean isLocalPlayerCreative() { return this.commandOwner.isLocalPlayerCreative(); }
