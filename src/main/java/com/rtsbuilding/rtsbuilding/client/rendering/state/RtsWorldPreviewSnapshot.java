 ...
 */
public record RtsWorldPreviewSnapshot(List<ModelGhost> modelGhosts) {
    public static final RtsWorldPreviewSnapshot EMPTY = new RtsWorldPreviewSnapshot(List.of());
