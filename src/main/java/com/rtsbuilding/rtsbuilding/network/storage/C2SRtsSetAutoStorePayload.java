...
public record C2SRtsSetAutoStorePayload(
    ...
    public static final Type<C2SRtsSetAutoStorePayload> TYPE = new Type<>(new ResourceLocation(RtsbuildingMod.MODID, "c2s_rts_set_auto_store"), C2SRtsSetAutoStorePayload.class);
