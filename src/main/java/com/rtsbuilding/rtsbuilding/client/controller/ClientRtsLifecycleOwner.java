...
final class ClientRtsLifecycleOwner {
    ...
    void tick() {
        ...
        if (hasRemoteMenuOpen
            ...
            if (controller.screenlessRemoteMenuTicks >= SCREENLESS_REMOTE_MENU_RECOVERY_TICKS) {
        ...
        boolean storageViewVisible = controller.isStorageViewVisibleForAutoRefresh(minecraft);
