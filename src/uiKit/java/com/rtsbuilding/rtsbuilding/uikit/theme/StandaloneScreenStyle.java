...
public final class StandaloneScreenStyle {
    ...
    public static final UiColor INPUT_BORDER_LIGHT = UiColor.themeComponent(
            UiThemeCoverageCatalog.ComponentFamily.MODAL,
            UiThemeToken.BORDER_STRONG, 0XFFA0A0A0);
    public static final UiColor INPUT_BACKGROUND = UiColor.themeComponent(
            UiThemeCoverageCatalog.ComponentFamily.MODAL,
            UiThemeToken.SURFACE_SUNKEN, 0XFF101010);
    public static final UiColor INPUT_TEXT = UiColor.themeComponent(
            UiThemeCoverageCatalog.ComponentFamily.MODAL,
            UiThemeToken.TEXT_PRIMARY, 0XFFE0E0E0);
    public static final UiColor INPUT_CURSOR = UiColor.themeComponent(
            UiThemeCoverageCatalog.ComponentFamily.MODAL,
            UiThemeToken.TEXT_SECONDARY, 0XFFD0D0D0);
