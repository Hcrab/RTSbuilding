 ...
 */
final class RtsStorageUiPayloads {
     ...
     * stable.
     */
    static List<String> buildQuickSlotPayload(RtsStorageSession session, int quickSlotCount) {
    ...
    static List<ItemStack> buildQuickSlotPreviewPayload(RtsStorageSession session, int quickSlotCount) {
     ...
     * binding slot.
     */
    static List<String> buildGuiBindingLabelPayload(RtsStorageSession session, int guiBindingSlotCount) {
     ...
     */
    static List<String> buildGuiBindingItemIdPayload(RtsStorageSession session, int guiBindingSlotCount) {
