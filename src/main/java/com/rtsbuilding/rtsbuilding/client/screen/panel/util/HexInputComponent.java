...
public class HexInputComponent {
    ...
    public void render(GuiGraphics g, int mouseX, int mouseY,
        ...
        RtsClientUiUtil.drawNineSliceRegion(g, inputSpec.withTheme(), inputX, inputY, inputW, INPUT_H);

        RtsClientUiUtil.drawUiText(g, inputLabel, previewX,
        ...
        if (hexEditMode) {
            ...
            String displayText = RtsClientUiUtil.trimToWidth(font, inputText, Math.max(8, inputW - 6));
        ...
        RtsClientUiUtil.renderCrossFade(modeBtnT,
                () -> RtsClientUiUtil.drawNineSliceRegion(g,
        ...
        RtsClientUiUtil.drawUiText(g, modeText,
