...
public record C2SRtsLinkStoragePayload(BlockPos pos, byte linkMode) implements CustomPacketPayload {
    ...
    public static final Type<C2SRtsLinkStoragePayload> TYPE = new Type<>(new ResourceLocation(RtsbuildingMod.MODID, "c2s_rts_link_storage"), C2SRtsLinkStoragePayload.class);
