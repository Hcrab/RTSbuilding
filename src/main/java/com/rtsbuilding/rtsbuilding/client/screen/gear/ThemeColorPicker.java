...
final class ThemeColorPicker {
    ...
    void render(RtsGuiContext g, int x, int y, boolean wheelDragging, boolean valueDragging) {
    ...
    private static void drawColorIndicator(
            RtsGuiContext g, int centerX, int centerY, int selectedArgb, boolean dragging) {
