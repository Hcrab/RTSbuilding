...
mainline glyphs and guide pixel-icon drawing paths. They contain no third-party
artwork and are original RTS Building assets covered by `LICENSE-ASSETS`; the
surrounding button-state palette remains derived from the credited PR #133 set.
