...
public final class RtsFunnelServiceImpl implements FunnelService {
    ...
    public void disableAndFlush(ServerPlayer player, RtsStorageSession session) {
        ...
        List<RtsItemHandler> handlers = new ArrayList<>(linked.size());
    ...
    private WorkResult flushBuffer(List<RtsItemHandler> handlers, ServerPlayer player,
    ...
    private WorkResult absorbDrops(ServerPlayer player, BlockPos target, List<RtsItemHandler> handlers,
            RtsStorageSession session, int maxUnits, long deadlineNanos) {
