...
public final class ClientRtsController extends ClientRtsWorkflowFacade {
    ...
    public void updateStoragePanelLayout(double xNormalized, double yNormalized, double widthNormalized, double heightNormalized) {
        this.stateQueryOwner.updateStoragePanelLayout(xNormalized, yNormalized, widthNormalized, heightNormalized);
    }
    ...
    public int getStorageEffectivePageSize() {
        return this.storageStateManager.getStorageEffectivePageSize();
    }
    public long getStorageGlobalIndex() {
        return this.storageStateManager.getStorageGlobalIndex();
    }
    public long getStorageSessionId() {
        return this.storageStateManager.getStorageSessionId();
    }
    public long getStorageQueryId() {
        return this.storageStateManager.getStorageQueryId();
    }
    public long getStorageServerDataRevision() {
        return this.storageStateManager.getStorageServerDataRevision();
    }
    ...
    public void linkStorageBatch(BlockPos first, BlockPos second, boolean allowStore) {
        this.commandOwner.linkStorageBatch(first, second, allowStore);
    }
    ...
    public void applyDamageFeedback(S2CRtsDamageFeedbackPayload payload) {
        this.interactionOwner.applyDamageFeedback(payload);
    }
    public void applyQuestDetectStatus(S2CRtsQuestDetectStatusPayload payload) {
        this.interactionOwner.applyQuestDetectStatus(payload);
    }
    public void applyMineProgress(S2CRtsMineProgressPayload payload) {
        this.interactionOwner.applyMineProgress(payload);
    }
    public void applyProgressionState(S2CRtsProgressionStatePayload payload) {
        this.interactionOwner.applyProgressionState(payload);
    }
    public void applyPluginState(S2CRtsPluginStatePayload payload) {
        this.interactionOwner.applyPluginState(payload);
    }
    public void requestPluginState() {
        this.interactionOwner.requestPluginState();
    }
    public void installPluginFromInventorySlot(int inventorySlot) {
        this.interactionOwner.installPluginFromInventorySlot(inventorySlot);
    }
    public void uninstallPlugin(String pluginId) {
        this.interactionOwner.uninstallPlugin(pluginId);
    }
    public void requestProgressionState() {
        this.interactionOwner.requestProgressionState();
    }
    public void setSurvivalProgressionEnabled(boolean enabled) {
        this.interactionOwner.setSurvivalProgressionEnabled(enabled);
    }
    public void setHome(BlockPos pos) {
        this.interactionOwner.setHome(pos);
    }
    public void beginHomeSelection() {
        this.interactionOwner.beginHomeSelection();
    }
    ...
    public void placeSelected(BlockHitResult hit, boolean forcePlace, Vec3 rayOrigin, Vec3 rayDir, boolean skipIfOccupied,
            boolean quickBuild) {
        this.interactionOwner.placeSelected(hit, forcePlace, rayOrigin, rayDir, skipIfOccupied, quickBuild);
    }
    ...
    public void placeSelectedBatch(List<BlockHitResult> hits, BlockHitResult templateHit, boolean forcePlace,
        ...
        this.interactionOwner.placeSelectedBatch(hits, templateHit, forcePlace, rayOrigin, rayDir, skipIfOccupied);
    }
    public void placeSelectedBatch(List<BlockHitResult> hits, BlockHitResult templateHit, boolean forcePlace,
            Vec3 rayOrigin, Vec3 rayDir, boolean skipIfOccupied, boolean overwriteExisting) {
        this.interactionOwner.placeSelectedBatch(hits, templateHit, forcePlace, rayOrigin, rayDir, skipIfOccupied, overwriteExisting);
    }
    ...
    public void confirmSmartFill(BlockHitResult hit, int maxBlocks, int detectionDiameter,
        ...
        this.interactionOwner.confirmSmartFill(hit, maxBlocks, detectionDiameter, rayOrigin, rayDirection);
    }
    ...
    public void interactBlockWithToolSlot(BlockHitResult hit, int toolSlot, Vec3 rayOrigin, Vec3 rayDir) {
        this.interactionOwner.interactBlockWithToolSlot(hit, toolSlot, rayOrigin, rayDir);
    }
    public void useItemInAirWithToolSlot(BlockHitResult hit, int toolSlot, Vec3 rayOrigin, Vec3 rayDir) {
        this.interactionOwner.useItemInAirWithToolSlot(hit, toolSlot, rayOrigin, rayDir);
    }
    ...
    public void interactEntityWithToolSlot(int entityId, Vec3 hitLocation, int toolSlot, Vec3 rayOrigin, Vec3 rayDir) {
        this.interactionOwner.interactEntityWithToolSlot(entityId, hitLocation, toolSlot, rayOrigin, rayDir);
    }
    public void interactEntityWithPinnedItem(int entityId, Vec3 hitLocation, String itemId, Vec3 rayOrigin, Vec3 rayDir) {
        this.interactionOwner.interactEntityWithPinnedItem(entityId, hitLocation, itemId, rayOrigin, rayDir);
    }
    ...
    public void startMining(BlockPos pos, int face, int toolSlot, RtsTraceInputKind inputKind) {
    ...
    public void confirmAreaMine(int toolSlot, ShapeFillMode fillMode, RtsTraceInputKind inputKind) {
        this.interactionOwner.confirmAreaMine(toolSlot, fillMode, inputKind);
    }
    public void confirmShapeAreaDestroy(List<BlockPos> targets, int toolSlot, RtsTraceInputKind inputKind) {
    ...
    public void confirmConvenienceDestroy(
            ...
            int toolSlot, RtsTraceInputKind inputKind) {
    ...
    boolean isStorageViewVisibleForAutoRefresh(Minecraft minecraft) {
