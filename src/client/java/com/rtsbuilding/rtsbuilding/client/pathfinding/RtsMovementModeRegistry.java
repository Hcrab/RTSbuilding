...
public final class RtsMovementModeRegistry {
    ...
    public static final Event<RegistrationCallback> REGISTRATION_EVENT =
            EventFactory.createArrayBacked(
                    RegistrationCallback.class,
                    callbacks -> event -> {
    ...
    public static void fireRegistrationEvent() {
        REGISTRATION_EVENT.invoker().register(new RegisterMovementModeEvent());
    }
    ...
    public interface RegistrationCallback {
        void register(RegisterMovementModeEvent event);
    }

    public static final class RegisterMovementModeEvent {
        private RegisterMovementModeEvent() {
        }

        public void register(MovementModeHandler handler, int priority) {
            RtsMovementModeRegistry.register(handler, priority);
        }

        public void register(MovementModeHandler handler) {
            RtsMovementModeRegistry.register(handler);
        }
    }
}
