...
public record C2SRtsSetProgressionCostPayload(ResourceLocation nodeId, String costsText) implements CustomPacketPayload {
    public static final Type<C2SRtsSetProgressionCostPayload> TYPE = new Type<>(new ResourceLocation(RtsbuildingMod.MODID, "c2s_rts_set_progression_cost"), C2SRtsSetProgressionCostPayload.class);
