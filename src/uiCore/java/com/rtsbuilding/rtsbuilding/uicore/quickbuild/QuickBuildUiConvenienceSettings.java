...
public final class QuickBuildUiConvenienceSettings {
    ...
    public QuickBuildUiConvenienceSettings with(
        ...
        switch (parameter) {
            case SIZE_X: return new QuickBuildUiConvenienceSettings(value, sizeY, sizeZ, chunkUp, chunkDown, treeMaxBlocks);
            case SIZE_Y: return new QuickBuildUiConvenienceSettings(sizeX, value, sizeZ, chunkUp, chunkDown, treeMaxBlocks);
            case SIZE_Z: return new QuickBuildUiConvenienceSettings(sizeX, sizeY, value, chunkUp, chunkDown, treeMaxBlocks);
            case CHUNK_UP: return new QuickBuildUiConvenienceSettings(sizeX, sizeY, sizeZ, value, chunkDown, treeMaxBlocks);
            case CHUNK_DOWN: return new QuickBuildUiConvenienceSettings(sizeX, sizeY, sizeZ, chunkUp, value, treeMaxBlocks);
            case TREE_MAX_BLOCKS: return new QuickBuildUiConvenienceSettings(sizeX, sizeY, sizeZ, chunkUp, chunkDown, value);
            default: throw new IllegalArgumentException("parameter");
        }
    }
    ...
    @Override public boolean equals(Object other) {
        ...
        return sizeX == value.sizeX && sizeY == value.sizeY && sizeZ == value.sizeZ && chunkUp == value.chunkUp && chunkDown == value.chunkDown && treeMaxBlocks == value.treeMaxBlocks;
    }
    ...
    @Override public int hashCode() {
        ...
        return 31 * result + treeMaxBlocks;
    }
