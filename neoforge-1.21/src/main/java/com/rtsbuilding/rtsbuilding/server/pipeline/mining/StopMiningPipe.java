 ...
 *
 * <p>Unlike {@link StopPreviousPipe} (which is part of a "start new operation" pipeline),
 * this Pipe is designed as a standalone stop operation —
 * e.g. when the player clicks the "stop" button or disables RTS mode.</p>
 *
