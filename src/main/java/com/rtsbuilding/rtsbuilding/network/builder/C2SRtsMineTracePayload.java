...
public record C2SRtsMineTracePayload(
    ...
    public static final Type<C2SRtsMineTracePayload> TYPE = new Type<>(
            new ResourceLocation(RtsbuildingMod.MODID, "c2s_rts_mine_v2"), C2SRtsMineTracePayload.class);
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, C2SRtsMineTracePayload> STREAM_CODEC = StreamCodec.of(
            ...
            buf -> {
                ...
                ItemStack tool = buf.readBoolean() ? com.rtsbuilding.rtsbuilding.forgecompat.network.RtsForgeBufCodecs.readItem(buf) : ItemStack.EMPTY;
    ...
    static void writeTool(RegistryFriendlyByteBuf buf, String toolItemId, ItemStack toolPrototype) {
        ...
        if (!tool.isEmpty()) com.rtsbuilding.rtsbuilding.forgecompat.network.RtsForgeBufCodecs.writeItem(buf, tool);
    }
