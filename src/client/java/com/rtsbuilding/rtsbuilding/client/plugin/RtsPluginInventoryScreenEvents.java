...
public final class RtsPluginInventoryScreenEvents {
    ...
    public static void onInventoryInit(RtsScreenEvent.Init.Post event) {
    ...
    public static void onInventoryMousePressed(RtsScreenEvent.MouseButtonPressed.Pre event) {
        Screen screen = event.getScreen();
        if (!(screen instanceof InventoryScreen inventoryScreen) || !isShiftDown()) {
            return;
        }
        Slot slot = ((AbstractContainerScreenAccessor) inventoryScreen).getHoveredSlot();
