...
public final class RtsAiChatPanel extends RtsWindowPanel {
    ...
    protected void renderContent(GuiGraphicsExtractor g, int mouseX, int mouseY, float partialTick) {
        ...
        g.text(screen.font(), limit, x, y + LIMIT_TEXT_Y_OFFSET,
        ...
        try {
            ...
            for (int i = first; i < end; i++) {
                ...
                g.text(screen.font(), line.text(), x + TRANSCRIPT_TEXT_X_INSET,
        ...
        RtsWidgetCompat.render(this.input, g, mouseX, mouseY, partialTick);
    ...
    protected void handleContentClick(double mouseX, double mouseY, int button) {
        ...
        if (RtsWidgetCompat.mouseClicked(this.input, mouseX, mouseY, button)) {
            return;
        }
    ...
    protected boolean handleWindowKeyPressed(int keyCode, int scanCode, int modifiers) {
        if (this.input != null && this.input.isFocused()) {
            if (keyCode == GLFW.GLFW_KEY_ENTER || keyCode == GLFW.GLFW_KEY_KP_ENTER) {
                ...
                RtsWidgetCompat.keyPressed(this.input, keyCode, scanCode, modifiers);
            }
    ...
    protected boolean handleWindowCharTyped(char codePoint, int modifiers) {
        return this.input != null && RtsWidgetCompat.charTyped(this.input, codePoint);
    }
    ...
    private void drawButton(GuiGraphicsExtractor g, String stableId, int x, int y, int w, int h,
