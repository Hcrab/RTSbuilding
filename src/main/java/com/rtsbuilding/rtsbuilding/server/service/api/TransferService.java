 ...
 *
 * <p>该接口定义了玩家与远程链接存储系统之间的各种物品传输操作： 包括将手持物品存入链接存储、从链接存储拾取物品、 快速丢弃、菜单槽位导入、快速移动以及批量填充背包等。
 */
public interface TransferService {

  /**
   * 统计链接存储中匹配指定谓词的物品总数量。 用于客户端查询特定物品的可用总量。
   *
   * @param player 目标玩家
  ...
  /**
   * 从链接存储快速移动指定物品到玩家背包或当前打开的菜单。 相当于快速移动（Shift+点击）操作。
   *
   * @param player 目标玩家
  ...
  /**
   * 从链接存储中取出物品填充玩家的背包（直至背包满）。 用于一键补货操作。
   *
   * @param player 目标玩家
   */
