...
public record C2SRtsImportMenuSlotPayload(int menuSlot) implements CustomPacketPayload {
    public static final Type<C2SRtsImportMenuSlotPayload> TYPE = new Type<>(new ResourceLocation(RtsbuildingMod.MODID, "c2s_rts_import_menu_slot"), C2SRtsImportMenuSlotPayload.class);
