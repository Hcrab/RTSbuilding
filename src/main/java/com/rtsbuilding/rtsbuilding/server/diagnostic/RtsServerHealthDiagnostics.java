 ...
 * 低成本服务端 tick 健康采样器。
 *
 * <p>它只陈述墙钟间隔与 RTS 已测调度量，不做 CPU 归因，也不改变任务预算。</p>
 */
public final class RtsServerHealthDiagnostics {
    ...
    public static synchronized void completeTick(
        ...
        if (level() == RtsDiagnosticLevel.OFF || server == null || stats == null || queue == null) return;
        ...
        String message = "[RTS-SERVER-HEALTH] schema=2 run={} event={} server_tick={} gap_ms={} severity={} "
        ...
        Object[] values = {RtsTraceIds.runId(), event, tick, gapMs,
        ...
        RtsStructuredDiagnostics.appendServer(event,
