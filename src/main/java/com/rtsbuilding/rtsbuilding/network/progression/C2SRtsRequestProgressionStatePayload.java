...
public record C2SRtsRequestProgressionStatePayload() implements CustomPacketPayload {
    public static final Type<C2SRtsRequestProgressionStatePayload> TYPE = new Type<>(new ResourceLocation(RtsbuildingMod.MODID, "c2s_rts_request_progression_state"), C2SRtsRequestProgressionStatePayload.class);
