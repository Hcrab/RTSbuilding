...
public record C2SRtsUnlockProgressionNodePayload(ResourceLocation nodeId) implements CustomPacketPayload {
    public static final Type<C2SRtsUnlockProgressionNodePayload> TYPE = new Type<>(new ResourceLocation(RtsbuildingMod.MODID, "c2s_rts_unlock_progression_node"), C2SRtsUnlockProgressionNodePayload.class);
