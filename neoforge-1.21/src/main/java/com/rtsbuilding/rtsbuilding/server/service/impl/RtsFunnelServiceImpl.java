...
/**
 * {@link RtsFunnelServiceImpl} 的默认实现——处理掉落物漏斗的启用/禁用、
 ...
 */
public final class RtsFunnelServiceImpl implements RtsService {
    ...
    public void tick(ServerPlayer player, RtsStorageSession session) {
        ...
        if (changed) {
            server.page().markStorageViewDirty(player, session);
