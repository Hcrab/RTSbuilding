...
abstract class ClientRtsPreferenceFacade {
    ...
    protected boolean startCameraAtPlayerHead;
    protected boolean allowPlacedBlockRecovery;
    protected boolean toolProtectionEnabled = true;
    protected boolean playerStatusOverlayEnabled = true;
    protected boolean damageSoundEnabled = true;
    protected boolean damageAutoReturnEnabled = true;
