...
public final class BottomPanelCraftStyle {
    ...
    public static final UiColor SEARCH_UNEDITABLE_TEXT = UiColor.themeComponent(UiThemeCoverageCatalog.ComponentFamily.BOTTOM_BAR, UiThemeToken.TEXT_PRIMARY, 0XFFAAB8C8);
    ...
    public static final UiColor APPLY_DIRTY = UiColor.themeComponentWithLegacyAlpha(UiThemeCoverageCatalog.ComponentFamily.BOTTOM_BAR, UiThemeToken.TEXT_PRIMARY, 0XAA4C6E39);
    public static final UiColor TOGGLE_MAKE = UiColor.themeComponentWithLegacyAlpha(UiThemeCoverageCatalog.ComponentFamily.BOTTOM_BAR, UiThemeToken.TEXT_PRIMARY, 0XAA2C5A41);
    public static final UiColor TOGGLE_ALL = UiColor.themeComponentWithLegacyAlpha(UiThemeCoverageCatalog.ComponentFamily.BOTTOM_BAR, UiThemeToken.TEXT_PRIMARY, 0XAA5A3D2A);
    ...
    public static final UiColor BUTTON_TEXT_IDLE = UiColor.themeComponent(UiThemeCoverageCatalog.ComponentFamily.BOTTOM_BAR, UiThemeToken.TEXT_ON_ACCENT, 0XFFB8C7D6);
    ...
    public static final UiColor SLOT_AVAILABLE = UiColor.themeComponentWithLegacyAlpha(UiThemeCoverageCatalog.ComponentFamily.BOTTOM_BAR, UiThemeToken.SLOT_IDLE, 0XAA214131);
    public static final UiColor SLOT_UNAVAILABLE = UiColor.themeComponentWithLegacyAlpha(UiThemeCoverageCatalog.ComponentFamily.BOTTOM_BAR, UiThemeToken.SLOT_IDLE, 0XAA3F2323);
    public static final UiColor SLOT_BORDER_LIGHT = UiColor.themeComponent(UiThemeCoverageCatalog.ComponentFamily.BOTTOM_BAR, UiThemeToken.SLOT_IDLE, 0XFF596D84);
    public static final UiColor SLOT_BORDER_DARK = UiColor.themeComponent(UiThemeCoverageCatalog.ComponentFamily.BOTTOM_BAR, UiThemeToken.SLOT_IDLE, 0XFF11171E);
    public static final UiColor SLOT_COUNT = UiColor.themeComponent(UiThemeCoverageCatalog.ComponentFamily.BOTTOM_BAR, UiThemeToken.SLOT_IDLE, 0XFFE8F4FF);
    public static final UiColor SLOT_UNAVAILABLE_OVERLAY = UiColor.themeComponentWithLegacyAlpha(UiThemeCoverageCatalog.ComponentFamily.BOTTOM_BAR, UiThemeToken.SLOT_IDLE, 0X44220000);
