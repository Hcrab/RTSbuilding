 ...
 * {@link RtsWorkflowType#PLACE_SINGLE},
 * {@link RtsWorkflowType#PLACE_BATCH}
 * and {@link RtsWorkflowType#QUICK_BUILD}.
 * It reads the session and workflow entry ID from the pipeline context
 * and delegates to {@link RtsPlacementBatch#enqueuePlaceBatch}.</p>
 *
 * <p>This Pipe is declared as {@link PipelinePipe}{@code <PlaceContext>},
 * so the compiler enforces type safety —
 * use via {@link PipelineRegistry#placementPipeline(RtsWorkflowType)}.
 * Call {@link PlaceContext#require(PipelineContext)} for safe casting.</p>
 */
public final class PlacementExecutePipe implements PipelinePipe<PlaceContext> {

    // ── Argument key constants (used by PlaceContext accessors) ──
    ...
    public PipelineResult execute(PlaceContext ctx) {
        ...
        // ── Read placement arguments via type-safe accessors ──
