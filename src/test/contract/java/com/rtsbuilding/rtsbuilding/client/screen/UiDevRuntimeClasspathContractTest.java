...
class UiDevRuntimeClasspathContractTest {
    @Test
    void uiCoreAndKitAreRegisteredForFabricMainAndClientRuns() throws Exception {
        String uiBuild = Files.readString(Path.of("gradle/rts-ui.gradle"));

        assertTrue(uiBuild.contains("main {") && uiBuild.contains("client {")
        ...
        assertTrue(uiBuild.contains("runtimeClasspath += sourceSets.uiCore.output + sourceSets.uiKit.output"),
