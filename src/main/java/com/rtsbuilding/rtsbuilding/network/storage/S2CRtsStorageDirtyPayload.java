...
public record S2CRtsStorageDirtyPayload(boolean dirty) implements CustomPacketPayload {
    public static final Type<S2CRtsStorageDirtyPayload> TYPE = new Type<>(new ResourceLocation(RtsbuildingMod.MODID, "s2c_rts_storage_dirty"), S2CRtsStorageDirtyPayload.class);
