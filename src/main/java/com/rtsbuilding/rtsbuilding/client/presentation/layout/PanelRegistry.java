 ...
 * </ul>
 *
 * <p>特殊面板（{@link com.rtsbuilding.rtsbuilding.client.presentation.panel.background.ScreenBackgroundPanel}、
 * {@link com.rtsbuilding.rtsbuilding.client.presentation.panel.base.RtsFloatingWindowLayer}）
...
public final class PanelRegistry {
     ...
     * 依次询问各面板是否消费此事件。
     * <p>替代 {@code BuilderScreen} 中 4 行硬编码面板点击检测。</p>
     *
