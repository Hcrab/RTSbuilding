...
public final class ShapeModeState {
    ...
    public ShapeFillMode activeFillMode() { return this.activeFillMode; }
    public void setActiveFillMode(ShapeFillMode mode) {
        this.activeFillMode = requireMode(mode);
        syncActiveControls();
    }
    public boolean activeLineConnected() { return this.activeLineConnected; }
    public void setActiveLineConnected(boolean connected) {
        this.activeLineConnected = connected;
        syncActiveControls();
    }
    public int activeRotateDegrees() { return this.activeRotateDegrees; }
    public void setActiveRotateDegrees(int degrees) {
        this.activeRotateDegrees = normalizeDegrees(degrees);
        syncActiveRotation();
    }
    public ShapeFillMode buildFillMode() { return this.buildFillMode; }
    public void setBuildFillMode(ShapeFillMode mode) {
        this.buildFillMode = requireMode(mode);
        if (!this.destroyActive) this.activeFillMode = this.buildFillMode;
    }
    public boolean buildLineConnected() { return this.buildLineConnected; }
    public void setBuildLineConnected(boolean connected) { this.buildLineConnected = connected; }
    public int buildRotateDegrees() { return this.buildRotateDegrees; }
    public void setBuildRotateDegrees(int degrees) { this.buildRotateDegrees = normalizeDegrees(degrees); }
    public ShapeFillMode destroyFillMode() { return this.destroyFillMode; }
    public void setDestroyFillMode(ShapeFillMode mode) {
        this.destroyFillMode = requireMode(mode);
        if (this.destroyActive) this.activeFillMode = this.destroyFillMode;
    }
    public boolean destroyLineConnected() { return this.destroyLineConnected; }
    public void setDestroyLineConnected(boolean connected) { this.destroyLineConnected = connected; }
    public int destroyRotateDegrees() { return this.destroyRotateDegrees; }
    public void setDestroyRotateDegrees(int degrees) { this.destroyRotateDegrees = normalizeDegrees(degrees); }
    public boolean destroyActive() { return this.destroyActive; }

    /** 保存当前建造状态并恢复上一次范围破坏状态。 */
    public void switchToDestroy() {
        if (this.destroyActive) return;
    ...
    private void syncActiveRotation() {
        if (this.destroyActive) this.destroyRotateDegrees = this.activeRotateDegrees;
        else this.buildRotateDegrees = this.activeRotateDegrees;
    }
    ...
    private static int normalizeDegrees(int degrees) { return Math.floorMod(degrees, 360); }
}
