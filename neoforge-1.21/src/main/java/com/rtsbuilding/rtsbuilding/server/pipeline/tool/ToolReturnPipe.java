...
/**
 * Returns a borrowed mining tool (if any) to the player's inventory or linked storage.
 *
 * <p>Reads from shared data:</p>
 * <ul>
 *   <li>{@code "toolLease"} —— {@link RtsToolLease} previously borrowed (may not exist)</li>
 * </ul>
 *
 * <p>It is safe to include this Pipe even if no tool was borrowed —
 * it is skipped if no lease data exists.</p>
 */
