 ...
 *
 * <p>本类不负责执行交互，也不改变服务端范围/权限判断。它只让仍然读取
 * {@link Minecraft#hitResult} 的第三方客户端预览看见 RTS 光标，例如机械动力的
 * 强力胶框选预览。离开 BuilderScreen 后原版 GameRenderer 会继续正常维护该字段。</p>
 */
public final class RtsVanillaCursorHitBridge {
     ...
     *
     * <p>这是给少数仍然自行从玩家视线发射射线的第三方预览使用的窄入口；
     * 非 BuilderScreen、鼠标位于 UI 上或没有命中真实方块时一律返回 {@code null}。</p>
     */
