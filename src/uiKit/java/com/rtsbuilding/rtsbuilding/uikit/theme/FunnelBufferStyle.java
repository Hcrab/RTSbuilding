...
public final class FunnelBufferStyle {
    public static final UiColor TOGGLE_VISIBLE = UiColor.themeComponentWithLegacyAlpha(UiThemeCoverageCatalog.ComponentFamily.STORAGE, UiThemeToken.TEXT_PRIMARY, 0XAA2C4E3D);
    public static final UiColor TOGGLE_HIDDEN = UiColor.themeComponentWithLegacyAlpha(UiThemeCoverageCatalog.ComponentFamily.STORAGE, UiThemeToken.TEXT_PRIMARY, 0XAA2A2D36);
    ...
    public static final UiColor COUNT_TEXT = UiColor.themeComponent(UiThemeCoverageCatalog.ComponentFamily.STORAGE, UiThemeToken.TEXT_ON_ACCENT, 0XFFFFDFAE);
    public static final UiColor EMPTY_TEXT = UiColor.themeComponentWithLegacyAlpha(UiThemeCoverageCatalog.ComponentFamily.STORAGE, UiThemeToken.TEXT_PRIMARY, 0X99B4BCC8);
