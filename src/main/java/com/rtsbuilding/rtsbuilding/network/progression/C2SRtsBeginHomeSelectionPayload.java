...
public record C2SRtsBeginHomeSelectionPayload() implements CustomPacketPayload {
    public static final Type<C2SRtsBeginHomeSelectionPayload> TYPE = new Type<>(new ResourceLocation(RtsbuildingMod.MODID, "c2s_rts_begin_home_selection"), C2SRtsBeginHomeSelectionPayload.class);
