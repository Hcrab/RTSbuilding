...
public record S2CRtsDamageFeedbackPayload(float amount, boolean lowHealth) implements CustomPacketPayload {
    public static final Type<S2CRtsDamageFeedbackPayload> TYPE = new Type<>(new ResourceLocation(RtsbuildingMod.MODID, "s2c_rts_damage_feedback"), S2CRtsDamageFeedbackPayload.class);
