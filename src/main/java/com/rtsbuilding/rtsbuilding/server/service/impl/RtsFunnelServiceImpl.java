...
public final class RtsFunnelServiceImpl implements FunnelService {
    ...
    private WorkResult absorbDrops(ServerPlayer player, BlockPos target, List<IItemHandler> handlers,
        ...
        List<ExperienceOrb> experienceOrbs = RtsEntityQueries.getEntities(player.getLevel(),
                EntityTypeTest.forClass(ExperienceOrb.class), box,
                e -> e != null && e.isAlive() && e.getValue() > 0, queryLimit);
        ...
        for (Entity collectible : collectibles) {
            ...
            if (collectible instanceof ExperienceOrb) {
                ExperienceOrb experienceOrb = (ExperienceOrb) collectible;
