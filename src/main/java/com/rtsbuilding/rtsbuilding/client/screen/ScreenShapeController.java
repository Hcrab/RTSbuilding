...
import static com.rtsbuilding.rtsbuilding.client.screen.BuilderScreenConstants.SHAPE_MAX_DIMENSION;
...
public final class ScreenShapeController {
    ...
    private BlockState resolvePendingGhostBlockState(BlockPos targetPos) {
        ...
        if (rotateDegrees != 0) {
            state = BuildGhostBlockStateResolver.applyRotation(state, rotateDegrees);
        }
        return state;
    }
