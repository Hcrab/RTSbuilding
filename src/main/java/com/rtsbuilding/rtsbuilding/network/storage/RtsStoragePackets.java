...
/**
 * Registers linked-storage browser, GUI binding, and overlay transfer packets. This class groups
 * packet registration only; payload ids, codecs, and packet directions stay in the payload records.
 */
