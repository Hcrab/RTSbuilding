...
final class InteractionTargetOcclusionPolicy {
    static boolean shapeSelectionBlocks(boolean quickBuildOpen, boolean rangeDestroyMode, ShapeBuildTypes.Phase phase) {
        return quickBuildOpen && rangeDestroyMode && phase == ShapeBuildTypes.Phase.READY_CONFIRM;
    }
