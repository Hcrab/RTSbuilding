...
public final class RtsAiHelpClipboard {
    private static final Identifier CHINESE_TUTORIAL =
            Identifier.fromNamespaceAndPath(RtsbuildingMod.MODID, "tutorial/ai_help_zh_cn.md");
    private static final Identifier ENGLISH_TUTORIAL =
            Identifier.fromNamespaceAndPath(RtsbuildingMod.MODID, "tutorial/ai_help_en_us.md");
    ...
    private static String readTutorial(Minecraft minecraft, Identifier id) {
        try {
