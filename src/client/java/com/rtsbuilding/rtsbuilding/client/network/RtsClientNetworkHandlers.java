...
public final class RtsClientNetworkHandlers {
    ...
    public static void handleCameraState(S2CRtsCameraStatePayload payload, RtsPayloadContext context) {
        context.enqueueWork(() -> ClientRtsController.get().applyServerCameraState(payload));
    }

    public static void handleCameraAnchor(S2CRtsCameraAnchorPayload payload, RtsPayloadContext context) {
        context.enqueueWork(() -> ClientRtsController.get().applyServerCameraAnchor(payload));
    }

    public static void handleStoragePage(S2CRtsStoragePagePayload payload, RtsPayloadContext context) {
        context.enqueueWork(() -> {
    ...
    public static void handleStorageDirty(S2CRtsStorageDirtyPayload payload, RtsPayloadContext context) {
        context.enqueueWork(() -> ClientRtsController.get().applyStorageDirty(payload));
    }

    public static void handleRemoteMenuHint(S2CRtsRemoteMenuHintPayload payload, RtsPayloadContext context) {
    ...
    public static void handleCraftFeedback(S2CRtsCraftFeedbackPayload payload, RtsPayloadContext context) {
        context.enqueueWork(() -> ClientRtsController.get().applyCraftFeedback(payload));
    }

    public static void handleCullingState(S2CRtsCullingStatePayload payload, RtsPayloadContext context) {
        context.enqueueWork(() -> RtsCullingClientState.applyCurrentWorldState(payload));
    }

    public static void handleDamageFeedback(S2CRtsDamageFeedbackPayload payload, RtsPayloadContext context) {
        context.enqueueWork(() -> ClientRtsController.get().applyDamageFeedback(payload));
    }

    public static void handleQuestDetectStatus(S2CRtsQuestDetectStatusPayload payload, RtsPayloadContext context) {
        context.enqueueWork(() -> ClientRtsController.get().applyQuestDetectStatus(payload));
    }

    public static void handleMineProgress(S2CRtsMineProgressPayload payload, RtsPayloadContext context) {
        context.enqueueWork(() -> ClientRtsController.get().applyMineProgress(payload));
    }

    public static void handleUltimineProgress(S2CRtsUltimineProgressPayload payload, RtsPayloadContext context) {
    ...
    public static void handlePlaceAnimation(S2CRtsPlaceAnimationPayload payload, RtsPayloadContext context) {
        context.enqueueWork(() -> {
    ...
    public static void handleBreakAnimation(S2CRtsBreakAnimationPayload payload, RtsPayloadContext context) {
        context.enqueueWork(() -> {
    ...
    public static void handleBlockActionSound(S2CRtsBlockActionSoundPayload payload, RtsPayloadContext context) {
        context.enqueueWork(() -> RtsBlockActionSoundPlayer.play(payload));
    }

    public static void handleProgressionState(S2CRtsProgressionStatePayload payload, RtsPayloadContext context) {
        context.enqueueWork(() -> ClientRtsController.get().applyProgressionState(payload));
    }

    public static void handlePluginState(S2CRtsPluginStatePayload payload, RtsPayloadContext context) {
        context.enqueueWork(() -> ClientRtsController.get().applyPluginState(payload));
    }

    public static void handleHistorySync(S2CRtsHistorySyncPayload payload, RtsPayloadContext context) {
        context.enqueueWork(() -> PlacementHistoryManager.syncHistoryState(
                payload.undoSize(), payload.redoSize()));
    }

    public static void handleWorkflowProgress(S2CRtsWorkflowProgressPayload payload, RtsPayloadContext context) {
        context.enqueueWork(() -> {
    ...
    public static void handleWorkflowProgressBatch(S2CRtsWorkflowProgressBatchPayload payload, RtsPayloadContext context) {
        context.enqueueWork(() -> {
    ...
    public static void handleResumePlacementScan(S2CRtsResumePlacementScanPayload payload, RtsPayloadContext context) {
        context.enqueueWork(() -> {
    ...
    public static void handleBlueprintResumeScan(S2CRtsBlueprintResumeScanPayload payload, RtsPayloadContext context) {
        context.enqueueWork(() -> {
            if (Minecraft.getInstance().screen instanceof BuilderScreen bs) {
    ...
    public static void handleBlueprintStatus(S2CBlueprintStatusPayload payload, RtsPayloadContext context) {
