...
public record C2SRtsLinkedQuickMovePayload(ItemStack prototype) implements CustomPacketPayload {
    public static final Type<C2SRtsLinkedQuickMovePayload> TYPE = new Type<>(new ResourceLocation(RtsbuildingMod.MODID, "c2s_rts_linked_quick_move"), C2SRtsLinkedQuickMovePayload.class);
