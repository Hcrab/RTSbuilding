...
public record C2SRtsRequestStoragePagePayload(
    ...
    public static final Type<C2SRtsRequestStoragePagePayload> TYPE = new Type<>(new ResourceLocation(RtsbuildingMod.MODID, "c2s_rts_request_storage_page_v2"), C2SRtsRequestStoragePagePayload.class);

    /** 保留旧的源码构造形状；真正的网络入口必须携带上下文。 */
