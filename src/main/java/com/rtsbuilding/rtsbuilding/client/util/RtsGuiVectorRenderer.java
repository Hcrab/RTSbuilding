 ...
 * RTS 界面的轻量几何图形绘制器。
 *
 * <p>这里有意只通过 {@link GuiGraphicsExtractor#fill(int, int, int, int, int)} 绘制，不接管 Minecraft
...
public final class RtsGuiVectorRenderer {
    ...
    public static void fillDisc(
        ...
        pose.scale(INVERSE_SUBPIXEL_SCALE, INVERSE_SUBPIXEL_SCALE);
    ...
    private static void drawDiscAtOrigin(GuiGraphicsExtractor graphics, int radius, int color) {
