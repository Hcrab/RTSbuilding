...
public record C2SRtsToggleCameraPayload(boolean startAtPlayerHead) implements CustomPacketPayload {
    public static final Type<C2SRtsToggleCameraPayload> TYPE = new Type<>(new ResourceLocation(RtsbuildingMod.MODID, "c2s_rts_toggle_camera"), C2SRtsToggleCameraPayload.class);
