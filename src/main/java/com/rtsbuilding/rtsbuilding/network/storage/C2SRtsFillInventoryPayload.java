...
public record C2SRtsFillInventoryPayload() implements CustomPacketPayload {
    public static final Type<C2SRtsFillInventoryPayload> TYPE = new Type<>(new ResourceLocation(RtsbuildingMod.MODID, "c2s_rts_fill_inventory"), C2SRtsFillInventoryPayload.class);
