...
/**
 * Borrows a mining tool from the player's inventory or linked storage for an operation.
 *
 ...
 * <ul>
 *   <li>{@code "toolLease"} —— {@link RtsToolLease} borrowed tool lease</li>
...
public final class ToolBorrowPipe implements PipelinePipe<MiningContext> {
    ...
    public PipelineResult execute(MiningContext ctx) {
        // Queue mode: tool already borrowed from current active operation
