...
public record C2SRtsSetSurvivalProgressionPayload(boolean enabled) implements CustomPacketPayload {
    public static final Type<C2SRtsSetSurvivalProgressionPayload> TYPE = new Type<>(new ResourceLocation(RtsbuildingMod.MODID, "c2s_rts_set_survival_progression"), C2SRtsSetSurvivalProgressionPayload.class);
