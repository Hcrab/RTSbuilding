...
public class ResetButton {
    ...
    public void render(GuiGraphics g, int mx, int my, int btnX, int btnY) {
        ...
        RtsClientUiUtil.renderCrossFade(t,
                () -> RtsClientUiUtil.drawSprite(g, normalRegion.withTheme(), btnX, btnY, BTN_SIZE, BTN_SIZE),
                () -> RtsClientUiUtil.drawSprite(g, hoverRegion.withTheme(), btnX, btnY, BTN_SIZE, BTN_SIZE));
    }
