 ...
 * <ul>
 *   <li>{@code "workflowType"} —— {@link RtsWorkflowType} (optional; defaults to the pipe's type)</li>
 *   <li>{@code "workflowPriority"} —— {@link RtsWorkflowPriority} (optional; defaults to NORMAL)</li>
 *   <li>{@code "totalBlocks"} —— {@code int} total blocks to process (0 means unknown)</li>
 * </ul>
 *
 * <p>Stores the following in shared data:</p>
 * <ul>
 *   <li>{@code "workflowEntryId"} —— {@code int} immutable entry ID</li>
 * </ul>
 */
