...
final class ClientRtsCommandOwner {
    ...
    void linkStorageBatch(BlockPos first, BlockPos second, boolean allowStore) {
    ...
    void beginRemoteMenuOpenGrace() {
        controller.pendingRemoteMenuOpenTicks = Math.max(controller.pendingRemoteMenuOpenTicks, REMOTE_MENU_OPEN_GRACE_TICKS);
