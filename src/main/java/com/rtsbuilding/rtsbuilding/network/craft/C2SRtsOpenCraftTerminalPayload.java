...
public record C2SRtsOpenCraftTerminalPayload() implements CustomPacketPayload {
    public static final Type<C2SRtsOpenCraftTerminalPayload> TYPE = new Type<>(new ResourceLocation(RtsbuildingMod.MODID, "c2s_rts_open_craft_terminal"), C2SRtsOpenCraftTerminalPayload.class);
