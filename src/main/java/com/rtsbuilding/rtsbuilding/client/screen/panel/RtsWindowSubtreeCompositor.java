...
final class RtsWindowSubtreeCompositor {
    ...
    static void render(RtsGuiContext graphics, int logicalWidth, int logicalHeight,
    ...
    private static void composite(RtsGuiContext graphics, int width, int height, float opacity) {
        ...
        builder.vertex(matrix, 0.0F, height, 0.0F)
                .uv(0.0F, 0.0F).color(255, 255, 255, alpha).endVertex();
        builder.vertex(matrix, width, height, 0.0F)
                .uv(1.0F, 0.0F).color(255, 255, 255, alpha).endVertex();
        builder.vertex(matrix, width, 0.0F, 0.0F)
                .uv(1.0F, 1.0F).color(255, 255, 255, alpha).endVertex();
        builder.vertex(matrix, 0.0F, 0.0F, 0.0F)
                .uv(0.0F, 1.0F).color(255, 255, 255, alpha).endVertex();
