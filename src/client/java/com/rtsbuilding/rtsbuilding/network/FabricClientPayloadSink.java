...
final class FabricClientPayloadSink {
  ...
  static void dispatch(
      ClientPayloadDispatcher.Domain domain, Object payload, RtsPayloadContext context) {
    switch (domain) {
  ...
  private static void dispatchCamera(Object payload, RtsPayloadContext context) {
    switch (payload) {
      case S2CRtsCameraStatePayload value ->
          RtsClientNetworkHandlers.handleCameraState(value, context);
      case S2CRtsCameraAnchorPayload value ->
          RtsClientNetworkHandlers.handleCameraAnchor(value, context);
      default -> {}
    }
  }
  ...
  private static void dispatchStorage(Object payload, RtsPayloadContext context) {
    switch (payload) {
      case S2CRtsStoragePagePayload value ->
          RtsClientNetworkHandlers.handleStoragePage(value, context);
      case S2CRtsStorageDirtyPayload value ->
          RtsClientNetworkHandlers.handleStorageDirty(value, context);
      case S2CRtsRemoteMenuHintPayload value ->
          RtsClientNetworkHandlers.handleRemoteMenuHint(value, context);
      default -> {}
    }
  }
  ...
  private static void dispatchBuilder(Object payload, RtsPayloadContext context) {
    switch (payload) {
      case S2CRtsMineProgressPayload value ->
          RtsClientNetworkHandlers.handleMineProgress(value, context);
      case S2CRtsOperationTerminalPayload value ->
          RtsClientNetworkHandlers.handleOperationTerminal(value, context);
      case S2CRtsUltimineProgressPayload value ->
          RtsClientNetworkHandlers.handleUltimineProgress(value, context);
      case S2CRtsHarvestTierSkippedPayload value ->
          RtsClientNetworkHandlers.handleHarvestTierSkipped(value, context);
      case S2CRtsPlaceAnimationPayload value ->
          RtsClientNetworkHandlers.handlePlaceAnimation(value, context);
      case S2CRtsBreakAnimationPayload value ->
          RtsClientNetworkHandlers.handleBreakAnimation(value, context);
      case S2CRtsBlockActionSoundPayload value ->
          RtsClientNetworkHandlers.handleBlockActionSound(value, context);
      case S2CRtsHistorySyncPayload value ->
          RtsClientNetworkHandlers.handleHistorySync(value, context);
      case S2CRtsWorkflowProgressPayload value ->
          RtsClientNetworkHandlers.handleWorkflowProgress(value, context);
      case S2CRtsWorkflowProgressBatchPayload value ->
          RtsClientNetworkHandlers.handleWorkflowProgressBatch(value, context);
      case S2CRtsResumePlacementScanPayload value ->
          RtsClientNetworkHandlers.handleResumePlacementScan(value, context);
      case S2CRtsBlueprintResumeScanPayload value ->
          RtsClientNetworkHandlers.handleBlueprintResumeScan(value, context);
      default -> {}
    }
  }
  ...
  private static void dispatchCraft(Object payload, RtsPayloadContext context) {
    switch (payload) {
      case S2CRtsCraftablesPayload value ->
          RtsClientNetworkHandlers.handleCraftables(value, context);
      case S2CRtsCraftFeedbackPayload value ->
          RtsClientNetworkHandlers.handleCraftFeedback(value, context);
      default -> {}
    }
  }
  ...
  private static void dispatchProgression(Object payload, RtsPayloadContext context) {
    switch (payload) {
      case S2CRtsProgressionStatePayload value ->
          RtsClientNetworkHandlers.handleProgressionState(value, context);
      case S2CRtsQuestDetectStatusPayload value ->
          RtsClientNetworkHandlers.handleQuestDetectStatus(value, context);
      default -> {}
    }
  }
}
