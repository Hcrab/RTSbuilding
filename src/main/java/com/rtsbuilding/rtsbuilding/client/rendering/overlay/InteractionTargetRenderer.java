...
/**
 * 浜や簰鐩爣楂樹寒娓叉煋鍣?
 * 璐熻矗娓叉煋鐜╁榧犳爣鎮仠鐨勬柟鍧楁垨瀹炰綋锛屾彁渚涜瑙夊弽棣?
 */
public final class InteractionTargetRenderer {
    ...
    /**
     * 娓叉煋褰撳墠榧犳爣鎮仠鐨勪氦浜掔洰鏍囷紙鏂瑰潡鎴栧疄浣擄級
     *
     * @param minecraft Minecraft瀹㈡埛绔疄渚?
     * @param controller RTS鎺у埗鍣?
    ...
    private static void renderBlockHighlight(Minecraft minecraft, PoseStack poseStack, VertexConsumer lineBuffer, BlockPos pos) {
        ...
        // 鏈夊舰鐘讹細鎸夊疄闄呯鎾炵洅娓叉煋锛堟敮鎸佹ゼ姊€佸彴闃剁瓑涓嶈鍒欐柟鍧楋級
        if (shape != null) {
