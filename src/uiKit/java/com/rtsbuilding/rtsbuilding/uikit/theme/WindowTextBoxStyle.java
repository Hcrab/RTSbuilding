...
public final class WindowTextBoxStyle {
    ...
    public static final UiColor TEXT_UNEDITABLE = UiColor.themeComponent(UiThemeCoverageCatalog.ComponentFamily.SETTINGS, UiThemeToken.TEXT_PRIMARY, 0XFF777F8B);
